...
// Tool setting parameter names
    ...
    public static final String TOOL_EXT_OUTCOMES_DUEDATE = "ext_outcomes_duedate";
...
// Open tool options
    ...
    public static final String DATA_SELF_WINDOW_NAME = "_self";

// Signature methods
    public static final String DATA_SIGNATURE_METHOD_SHA1 = "SHA1";
    public static final String DATA_SIGNATURE_METHOD_SHA256 = "SHA256";
    public static final String DATA_SIGNATURE_METHOD_SHA384 = "SHA384";
    public static final String DATA_SIGNATURE_METHOD_SHA512 = "SHA512";
...
// location of image files
    public static final Map<String, String> IMAGE_FILE = new HashMap<String, String>() {
        {
...
// name of resource string for alt text of image files
    ...
    public static final Map<String, String> IMAGE_ALT_RESOURCE = new HashMap<String, String>() {
        {
