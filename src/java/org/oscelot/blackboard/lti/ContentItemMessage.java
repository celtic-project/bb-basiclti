...
public class ContentItemMessage extends LtiMessage {
    ...
    public ContentItemMessage(B2Context b2Context, Tool tool, Module module) {
        ...
        this.props.remove("resource_link_id");
        this.props.remove("resource_link_title");
        this.props.remove("resource_link_description");

        this.addProperty("lti_message_type", Constants.CONTENT_ITEM_MESSAGE_TYPE);
        this.setAcceptTypes("*/*");
...
// Context-level settings
    ...
    public void setReturnUrl(String returnUrl) {
        ...
        this.addProperty("content_item_return_url", returnUrl);
    }

    public void setAcceptTypes(String acceptTypes) {

        this.addProperty("accept_media_types", acceptTypes);
    }

    public void setTargets(String targets) {

        this.addProperty("accept_presentation_document_targets", targets);
    }
    ...
    public void setAcceptUnsigned(boolean unsigned) {
        ...
        this.addProperty("accept_unsigned", value);
    ...
    public void setAcceptMultiple(boolean multiple) {
        ...
        this.addProperty("accept_multiple", value);
