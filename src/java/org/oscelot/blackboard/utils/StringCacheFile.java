...
/**
 * StringCache is a singleton utility class to provide a memory cache for
 * strings.
 * It has options for setting the maximum age of an item (time after which the
 * entry
 * expires and is removed from the cache) and capacity (maximum number of
 * entries
