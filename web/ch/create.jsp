      ...
      <bbNG:stepGroup active="<%=urlTab%>" title="${bundle['page.content.create.tab.byurl']}">
        ...
        <bbNG:step hideNumber="false" title="${bundle['page.content.create.byurl.step3.title']}" instructions="${bundle['page.content.create.byurl.step3.instructions']}">
          ...
          <bbNG:dataElement isRequired="true" label="${bundle['page.content.modify.step4.duedate.label']}">
            <bbNG:checkboxElement isSelected="false" name="duedate_checkbox" id="duedate_checkbox" value="1" />
            <bbNG:datePicker checkBoxFieldId="duedate_checkbox" baseFieldName="duedate" showDate="true" showTime="true" />
          </bbNG:dataElement>
        </bbNG:step>
        <%
            }
